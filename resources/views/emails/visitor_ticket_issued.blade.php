...
<head>
    ...
    <title>E-Tiket Konferensi PIT IAGI-GEOSEA 2026</title>
</head>
<body style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height: 1.6; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f1f5f9;">
    ...
    <div style="background: #ffffff; padding: 35px 30px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 25px rgba(0,0,0,0.06); border: 1px solid #e2e8f0; border-top: none;">
        ...
        <p style="font-size: 16px; margin-top: 0; margin-bottom: 8px;">
            Halo <strong>{{ $ticket->visitor_name }}</strong>,
        </p>
        <p style="font-size: 14px; line-height: 1.7; color: #475569; margin-bottom: 25px;">
            Selamat! Pendaftaran tiket penonton Anda untuk <strong>55th PIT IAGI & GEOSEA XIX 2026</strong> telah <strong>BERHASIL & AKTIF</strong>. Berikut adalah rincian E-Tiket Digital resmi Anda:
        </p>
        ...
        <div style="background: #f8fafc; border: 2px dashed #094d42; border-radius: 14px; padding: 25px; margin-bottom: 25px; text-align: center;">
            <div style="margin-bottom: 15px;">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data={{ urlencode($ticket->ticket_code) }}" alt="QR Code Tiket" style="width: 150px; height: 150px; border-radius: 10px; border: 1px solid #cbd5e1; padding: 8px; background: #ffffff; display: inline-block;">
            </div>

            <div style="font-size: 11px; font-weight: 800; color: #64748b; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;">KODE TIKET ANDA</div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 25px; font-size: 13px;">
            <tr style="border-bottom: 1px solid #f1f5f9;">
                <td style="padding: 10px 0; color: #64748b; font-weight: 700; width: 140px;">Nama Pengunjung</td>
                <td style="padding: 10px 0; color: #0f172a; font-weight: 700;">{{ $ticket->visitor_name }}</td>
            </tr>
            <tr style="border-bottom: 1px solid #f1f5f9;">
                <td style="padding: 10px 0; color: #64748b; font-weight: 700;">Email Terdaftar</td>
                <td style="padding: 10px 0; color: #0f172a;">{{ $ticket->visitor_email }}</td>
            </tr>
            @if($ticket->visitor_phone)
            <tr style="border-bottom: 1px solid #f1f5f9;">
                <td style="padding: 10px 0; color: #64748b; font-weight: 700;">No. WhatsApp</td>
                <td style="padding: 10px 0; color: #0f172a;">{{ $ticket->visitor_phone }}</td>
            </tr>
            @endif
            @if($ticket->visitor_institution)
            <tr style="border-bottom: 1px solid #f1f5f9;">
                <td style="padding: 10px 0; color: #64748b; font-weight: 700;">Instansi / Kampus</td>
                <td style="padding: 10px 0; color: #0f172a; font-weight: 600;">{{ $ticket->visitor_institution }}</td>
            </tr>
            @endif
            <tr style="border-bottom: 1px solid #f1f5f9;">
                <td style="padding: 10px 0; color: #64748b; font-weight: 700;">Status Tiket</td>
                <td style="padding: 10px 0; color: #15803d; font-weight: 800;">AKTIF (Siap Digunakan)</td>
            </tr>
        </table>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ route('visitor.ticket.show', ['ticket_code' => $ticket->ticket_code]) }}" style="display: inline-block; background: linear-gradient(180deg, #094d42 0%, #064036 100%); color: #ffffff; text-decoration: none; padding: 14px 30px; border-radius: 12px; font-weight: 900; font-size: 15px; box-shadow: 0 4px 12px rgba(9,77,66,0.3);">
                📱 Buka E-Tiket & Kartu Lanyard Digital
            </a>
        </div>
        ...
        <div style="background: #f8fafc; border-left: 4px solid #094d42; padding: 15px 18px; border-radius: 0 8px 8px 0; margin-bottom: 25px;">
            <p style="margin: 0 0 6px 0; font-weight: 800; font-size: 13px; color: #0f172a;">
                📌 Petunjuk Saat Hari Acara:
            </p>
            <ul style="margin: 0; padding-left: 18px; font-size: 12px; color: #475569; line-height: 1.6;">
                <li>Tunjukkan QR Code pada link E-Tiket di atas kepada petugas di pintu masuk / scanner gate.</li>
                <li>Petugas akan memindai QR Code dan mencetak ID Card Lanyard resmi Anda di meja registrasi.</li>
                <li>Simpan email ini atau unduh E-Tiket Anda dalam format PDF/Gambar di ponsel Anda.</li>
            </ul>
        </div>
        ...
        <div style="text-align: center; border-top: 1px solid #e2e8f0; padding-top: 20px; font-size: 12px; color: #94a3b8;">
            <p style="margin: 0 0 5px 0;">
                Butuh bantuan? Hubungi panitia melalui email: <a href="mailto:admin@iagi-geosea2026.com" style="color: #094d42; font-weight: 700; text-decoration: none;">admin@iagi-geosea2026.com</a>
            </p>
