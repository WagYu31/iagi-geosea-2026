...
<head>
    ...
    <title>Payment Status Notice - PIT IAGI-GEOSEA 2026 Ticket</title>
</head>
<body style="font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height: 1.6; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f1f5f9;">
    ...
    <div style="background: #ffffff; padding: 35px 30px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 25px rgba(0,0,0,0.06); border: 1px solid #e2e8f0; border-top: none;">
        ...
        <div style="background: #fef2f2; border-left: 4px solid #ef4444; border-radius: 0 10px 10px 0; padding: 18px 20px; margin-bottom: 25px;">
            <div style="font-size: 11px; font-weight: 800; color: #991b1b; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;">COMMITTEE REMARKS / REASON:</div>
            <div style="font-size: 14px; font-weight: 700; color: #b91c1c; line-height: 1.6;">
                {{ $notes ?: 'Payment proof is invalid or transfer amount does not match.' }}
            </div>
        </div>

        <p style="font-size: 13px; color: #475569; line-height: 1.7; margin-bottom: 25px;">
            Please re-register with a clear and valid payment proof, or contact the conference secretariat team for further assistance.
        </p>

        <!-- CTA Button -->
        <div style="text-align: center; margin: 25px 0;">
            <a href="{{ route('visitor.tickets') }}" style="display: inline-block; background: linear-gradient(180deg, #094d42 0%, #064036 100%); color: #ffffff; text-decoration: none; padding: 14px 28px; border-radius: 12px; font-weight: 900; font-size: 14px; box-shadow: 0 4px 12px rgba(9,77,66,0.3);">
                🔄 Re-register Visitor Ticket
            </a>
        </div>
        ...
        <div style="text-align: center; border-top: 1px solid #e2e8f0; padding-top: 20px; font-size: 12px; color: #94a3b8; margin-top: 25px;">
            <p style="margin: 0 0 5px 0;">
                Committee Support: <a href="mailto:admin@iagi-geosea2026.com" style="color: #ef4444; font-weight: 700; text-decoration: none;">admin@iagi-geosea2026.com</a>
            </p>
