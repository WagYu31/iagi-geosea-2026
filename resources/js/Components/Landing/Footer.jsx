                    ...
                    <Grid container spacing={{ xs: 4, md: 6 }} sx={{ mb: { xs: 4, md: 5 } }}>
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                            ...
                            <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap' }}>
                                {[
                                    { icon: 'instagram', url: social.instagram || '#', hoverColor: '#E4405F' },
                                    { icon: 'facebook', url: social.facebook || '#', hoverColor: '#1877F2' },
                                    { icon: 'twitter', url: social.twitter || '#', hoverColor: '#1DA1F2' },
                                    { icon: 'youtube', url: social.youtube || '#', hoverColor: '#FF0000' },
                                ].map((item, index) => (
                                    <Box
                                        key={index}
                                        component="a"
